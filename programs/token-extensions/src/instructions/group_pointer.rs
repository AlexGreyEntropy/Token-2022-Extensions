...
pub fn create_mint_with_group_pointer(
    ...
    // space for mint with group pointer extension
    let space = ExtensionType::GroupPointer.try_calculate_account_len::<spl_token_2022::state::Mint>(&[])?;
